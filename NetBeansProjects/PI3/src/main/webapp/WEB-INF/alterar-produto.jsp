...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form onsubmit="return validafunc();" id="cadastro__produto" name="cadastro__produto" class="form" method="post" action="${pageContext.request.contextPath}/ProdutoAlterar" novalidate>
                <div class="linha">
                    <div class="coluna">
